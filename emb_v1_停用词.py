...
# 批复文件夹路径
PIFU_FOLDER = r"C:\Users\DELL\Desktop\批复"

# SDG文件路径
SDG_PATH = r"C:\Users\DELL\Desktop\sdg.txt"

# 停用词文件路径
STOPWORD_FILE = r"C:\Users\DELL\Desktop\hit_stop.txt"

# 结果输出Excel文件名
OUTPUT_EXCEL = "similarity_results.xlsx"
...
def get_document_embedding_with_retry(text, max_retries=3):
    ...
    return (avg_embedding / (norm + 1e-10)).reshape(1, -1)
